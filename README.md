...
### Using Postman ####
    ...
    For testing authorization, url for getting all organization requires an admin token while url for getting a single
    organization by id requires just a regular authentication.
